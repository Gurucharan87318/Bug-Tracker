        ...
        <Dialog open={creationModal} onOpenChange={setCreationModal}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Create a new kanban board. Specify a title and a description for your Project.
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input id="name" placeholder="Untitled Projects" className="col-span-3" ref={titleRef} />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
