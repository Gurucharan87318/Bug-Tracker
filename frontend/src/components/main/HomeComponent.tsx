  ...
  return (
    <div>
      <Alert className="mt-5">
        ...
        <AlertDescription>
          You can now create Projects and invite collaborators.
        </AlertDescription>
      </Alert>
      {isLoading && <p>Loading...</p>}
      <h1 className="text-xl font-bold my-5">Recent Projects</h1>
      {(data?.recentBoards.length || 0) > 0 ? (
        ...
        <div className="py-5 text-center">
            <p>Your recently opened Projects will show up here.</p>
        </div>
      )}
      ...
      {(data?.boards.length || 0) > 0 ? (
        ...
        <div className="py-5 text-center">
            <p>Your Projects will show up here. Create a new board to get started.</p>
        </div>
      )}
    </div>
  )
